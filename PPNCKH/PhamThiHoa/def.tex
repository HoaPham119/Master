...
% \renewcommand{\@oddhead}{\textit{Luận văn thạc sĩ - Chuyên ngành Đại số và Lý thuyết số}\hrulefill Trang \thepage} 
%tạo header trang lẻ
% \renewcommand{\@evenhead}{Trang \thepage \hrulefill \textit{Mẫu luận văn cao học}} 
%tạo header trang chẵn
%  \renewcommand{\@oddfoot}{\mbox{\emph{Luận văn cao học}}\dotfill Trang \thepage} 
% tạo footer trang lẻ
